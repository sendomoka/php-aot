...
document.querySelector('img[name="edit"]').addEventListener('click', function() {
  document.getElementById('content-2').style.display = 'none';
  document.getElementById('content-2-2').style.display = 'block';
  headerText.textContent = 'Timeline - Edit Data';
});

document.querySelector('img[name="detail"]').addEventListener('click', function() {
  document.getElementById('content-2').style.display = 'none';
...
(function() {
  ...
  x = document.getElementsByClassName("fraeth-select");
  l = x.length;
  for (i = 0; i < l; i++) {
    selElmnt = x[i].getElementsByTagName("select")[0];
    ll = selElmnt.length;
...
(function() {
  var x, i, j, l, ll, selElmnt, a, b, c;
  x = document.getElementsByClassName("status-select");
  l = x.length;
  for (i = 0; i < l; i++) {
    selElmnt = x[i].getElementsByTagName("select")[0];
    ll = selElmnt.length;
